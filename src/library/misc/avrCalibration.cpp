#include "avrCalibration.h"
#include "../avrGraphics.h"    //<-- Inclui a avrParameters
#include "../avrVision.h"
#include "../avrVideo.h"
#include "../avrMath.h"
...
void argInqSetting( int *hmdMode, int *gMiniXnum2, int *gMiniYnum2,
...
void argLineSegHMD( double x1, double y1, double x2, double y2 )
{
    ...
    ox = 0;
    oy = argGetWindowHeight() - argGetImageHeight();
    glBegin(GL_LINES);
