/*
  ...
  Description: class to represents a transformation matrix and its operations
*/
...
class avrMatrix3x4 : public avrMatrix
{
   public:
       ...
       * \return matrix in c format (mat[3][4])
       */
      ...
      // Special Gets
      //! gets the x coordinate of the translation (same as access(0, 3))
      double	X() const;
      //! gets the y coordinate of the translation (same as access(1, 3))
      double	Y() const;
      //! gets the z coordinate of the translation (same as access(2, 3))
      double	Z() const;
};
